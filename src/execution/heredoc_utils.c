...
int append_content_line(char **content, char *line, size_t *content_size, size_t *content_capacity)
{
    size_t line_len;
    size_t new_capacity;
    char *new_content;
...
int append_temp_content(char **temp_content, char *line, size_t *temp_size, size_t *temp_capacity)
{
...
void finalize_content(char **content, char **temp_content, size_t *temp_size)
{
    ...
    *temp_content = NULL;
    (void)temp_size; // Unused parameter
}
